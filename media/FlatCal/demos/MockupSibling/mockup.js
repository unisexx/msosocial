...
var gcCalBG="#773D08";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#773D08";	// the background color of the inner table, showing as a frame.
...
var giCellWidth=NN4?88:-1;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=80;	// calendar cell height;
var giHeadHeight=32;	// calendar head row height;
var giWeekWidth=44;	// calendar week-number-column width;
...
var gcToggle="#773D08";	// the highlight color for the focused cell

var gcFGToday="#773D08";	// the font color for today 
