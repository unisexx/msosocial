...
var gMonths=["มกราคม","กุมภาพันธั","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฏาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พศจิกายน", "ธันวาคม"];
...
var giCellWidth=29;	// calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=29;	// calendar cell height;
var giHeadHeight=25;	// calendar head row height;
...
var gcWorkday="#000000";	// Workday font color
var gcSat="#ed008c";	// Saturday font color
var gcSatBG="#f6f6f6";	// Saturday background color
var gcSun="#ed1c24";	// Sunday font color
var gcSunBG="#f6f6f6";	// Sunday background color

var gcOtherDay="white";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
var gcOtherDayBG="#fff3f8";	// the background color of days in other months. when giShowOther set to hiding, it'll substitute the gcOtherDay.
...
var gcToggle="#fed1e0";	// the highlight color for the focused cell

var gcFGToday="#000000";	// the font color for today 
var gcBGToday="#ee568d";	// the background color for today 
...
var gcFGSelected="#fed1e0";	// the font color for the selected date
