			...
			<div class="row-fluid">
				...
				<div class="table-header">
					<?=$_GET['module']?>
                    		...
                    		<form id="frmImportXMl" method="post" action="infos/admin/infos/xml_import?module=<?=$_GET['module']?>" enctype="multipart/form-data" />
									<input type="file" id="file_xml" name="file_xml" />
                                    <input type="submit" id="btnxml" name="btnxml" value="นำเข้าข้อมูล" />        			
                                    <span style="font-weight:normal; color: #FFF;"> *(XML File) </span>
                                    <a href="media/myxml.xml" target="_blank" style="font-weight:normal; color:#FFF;">( ดาวน์โหลดตัวอย่างข้อมูลไฟล์นำเข้า )</a>
                            </form>
