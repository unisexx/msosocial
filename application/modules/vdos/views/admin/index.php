				...
				<table id="sample-table-2" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th width="90">
								<a class="btn btn-mini btn-info" href="vdos/admin/vdos/form">เพิ่มรายการ</a>
							</th>
						</tr>
					</thead>
						...
						<tr>
							...
							<td class="td-actions">
								<div class="hidden-phone visible-desktop action-buttons">
									<a class="green" href="vdos/admin/vdos/form/<?php echo $row->id ?>">
										<i class="icon-pencil bigger-130"></i>
									</a>

									<a class="red" href="vdos/admin/vdos/delete/<?php echo $row->id?>" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">
								...
								<div class="hidden-desktop visible-phone">
									<div class="inline position-relative">
										...
										<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
											<li>
												<a href="vdos/admin/vdos/delete/<?=$row->id?>" class="tooltip-success" data-rel="tooltip" title="Edit">
													<span class="green">
											...
											<li>
												<a href="vdos/admin/vdos/delete/<?=$row->id?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick="return confirm('<?php echo lang('notice_confirm_delete');?>')">
													<span class="red">
