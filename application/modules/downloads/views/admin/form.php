...
<div class="page-content">
	...
	<div class="row-fluid">
		<div class="span12">
			<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" method="post" action="downloads/admin/downloads/save/<?php echo $rs->id ?>" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php echo form_dropdown('category_id',$rs->category->get_option(),$category_id,'');?>
						</div>
